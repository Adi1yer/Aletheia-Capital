...
class TestTradingPipeline:
    ...
    def trading_pipeline(self, mock_registry):
        ...
        with patch('src.trading.pipeline.AgentRegistry') as mock_registry_class, \
             patch('src.trading.pipeline.get_data_provider') as mock_data_provider, \
             patch('src.trading.pipeline.RiskManager') as mock_risk_manager, \
             patch('src.trading.pipeline.PortfolioManager') as mock_portfolio_manager, \
             patch('src.trading.pipeline.AlpacaBroker') as mock_broker:
